    ...
    while True:
        ...
        if COMM=="A" or COMM=="ADD":
            ...
            if(chosen_no <= 0):
                ...
                print("[-] Adding:", tmp_song_list[chosen_no-1][1], "from", tmp_song_list[chosen_no-1][2])
            ...
            if(chosen_no <= 0):
                ...
                print("[-] Deleting:", song_list_to_add[chosen_no-1][1], "by", tmp_song_list[chosen_no-1][2])
